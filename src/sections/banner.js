      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            <Heading as="h3">
              A cradle for IITM based Techno-Social <br/>Projects
            </Heading>
            <Text as="p">
              We help innovators and NGOs bring their vision to life by providing technical solutions to their problems
            </Text>
          </Box>
          <Box sx={styles.image}>
...
const styles = {
  banner: {
    ...
    pb: ['20px', null, null, null, '30px', null, '0'],
